                        ...
                        <Fade duration={300} delay={100} triggerOnce>
                            ...
                            >
                                <p className="index-page-section-one-text">
                                    We are sorry to inform you that registration
                                    is currently closed. We are working hard to
                                    bring you the best music education
                                    experience possible, and aim to start new
                                    classes during February 2025.
                                </p>
                            </Slide>
                        </Fade>
                        <Slide
