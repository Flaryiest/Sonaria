        ...
        <div className="classes-page">
            <div className="classes-page-section-one">
                <div className="classes-page-header-container">
                    ...
                    <div className="classes-page-sub-header">We offer a variety of classes for students of all ages and skill levels.</div>
            ...
            <div className="classes-page-section-two">
                <div className="classes-page-section-two-header">Upcoming</div>
